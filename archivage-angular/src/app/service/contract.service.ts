...
export class ContractService {
  ...
  searchContractByClientNameOrContractNumber(client_name: string, contract_number: string) {
    return this.httpClient.get<ContractDto[]>(environment.apiUrl+"/contract/get-contracts-by-client-name-number?client_name="+client_name+"&contract_number="+contract_number);
  }

  update(contract: ContractDto) {
    return this.httpClient.put(environment.apiUrl+"/contract/create-event-contract", contract);
  }
